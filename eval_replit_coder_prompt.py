...
if __name__ == "__main__":
    ...
    out_path = "results/replit_coder_prompt/eval.jsonl"
    os.makedirs("results/replit_coder_prompt", exist_ok=True)
    
    model_name_or_path = "/home/matthias/src/replit-finetune/llm/coder_prompt/hf"
